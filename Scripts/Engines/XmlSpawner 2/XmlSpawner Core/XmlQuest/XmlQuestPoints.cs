...
namespace Server.Engines.XmlSpawner2
{
	public class XmlQuestPoints : XmlAttachment
	{
		...
		{
			CommandSystem.Register( "QuestPoints", AccessLevel.Administrator, new CommandEventHandler( CheckQuestPoints_OnCommand ) );

			CommandSystem.Register( "QuestLog", AccessLevel.Administrator, new CommandEventHandler( QuestLog_OnCommand ) );
