...
namespace Server.Engines.PlayerDonation
{
	...
	public class DonationStore
	{
		...
		private static string
			DatabaseDriver = "{MySQL ODBC 5.2 Unicode Driver}",
			DatabaseServer = "server",	// your MySQL database hostname
			DatabaseName = "dbname",			// the database name of your donation store db
			DatabaseUserID = "dbuser",				// username for your MySQL database access
			DatabasePassword = "dbpass";	// password
