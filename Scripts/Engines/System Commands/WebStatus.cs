...
namespace Server.CurseWebsite
{
	public class StatusPage : Timer
	{
        ...
        */
			using ( StreamWriter op = new StreamWriter( "C:/Users/Scrubtasticx/Games/Emulators/WebServer/www/status.html" ) )
			{
		     op.WriteLine( "<html>" );
		     op.WriteLine( "   <head>" );
		     op.WriteLine( "      <title>Curse UO</title>");
		     op.WriteLine( "   </head>" );
