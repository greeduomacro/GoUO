		...
		public static List<string> DefaultEntries( int i )
		{
			...
			switch(i)
			{
				...
				case 2: // GameMaster
					...
					entries.Add("[Move"); entries.Add("[M Remove"); entries.Add("[Wipe"); entries.Add("[Kill"); entries.Add("[Recover"); entries.Add("[Self Unhide");
					break;
				case 3: // Seer
					goto case 2;
				case 4: // Administrator
					entries.Add("[Admin"); entries.Add("[GMBody"); entries.Add("[StaffRunebook"); entries.Add("[M Tele"); entries.Add("[Where"); entries.Add("[Who"); entries.Add("[Self Hide"); for( int j = 0; j < 1; j++ ){entries.Add("-");}
					entries.Add("[xmlshow"); entries.Add("[xmlhide"); entries.Add("[Move"); entries.Add("[M Remove"); entries.Add("[Wipe"); entries.Add("[Props"); entries.Add("[Recover"); entries.Add("[Self Unhide"); for( int j = 0; j < 1; j++ ){entries.Add("-");}
