...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Deed to a blue tent by Kelon, 03.Okt.2004
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace Server.Multis
{
	public class BlueTent : BaseHouse
	{
		...
		public BlueTent( Mobile owner ) : base( 0x70, owner, 1, 1 )
		{
			Price = 12000;
		...
		public override bool IsInside( Point3D p, int height )
		{
			...
			// Garten zählt immer dazu
/*			if( Garden != null && Garden.Count > 0 )
			{
				foreach ( Rectangle2D r in Garden )
				{
					if( r.Contains(p) )
						return true;
				}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Deed to a green tent by Kelon, 03.Okt.2004
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// GreenTent by Kelon, 03.Okt.2004
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace Server.Multis
{
	public class GreenTent : BaseHouse
	{
		...
		public GreenTent( Mobile owner ) : base( 0x72, owner, 1, 1 )
		{
			Price = 12000;
			uint keyValue = CreateKeys( owner );
